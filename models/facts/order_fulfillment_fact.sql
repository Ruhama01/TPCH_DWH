...
WITH order_lineitem_dates AS (
    SELECT
        ...
        MAX(L.L_RECEIPTDATE) AS MAX_L_RECEIPTDATE
...
SELECT
    ...
    COALESCE(DD_ORDER.DATE_KEY, TO_DATE('1900-01-01')) AS ORDER_DATE_SK,
    COALESCE(DD_SHIP.DATE_KEY, TO_DATE('1900-01-01')) AS SHIP_DATE_SK,
    COALESCE(DD_COMMIT.DATE_KEY, TO_DATE('1900-01-01')) AS COMMIT_DATE_SK,
    COALESCE(DD_RECEIPT.DATE_KEY, TO_DATE('1900-01-01')) AS RECEIPT_DATE_SK,
    ...
    CASE 
        WHEN OLD.O_ORDERSTATUS = 'F' THEN 'FULLY_DELIVERED'
